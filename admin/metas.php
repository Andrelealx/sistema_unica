    ...
    if ($acao === 'adicionarUso') {
        ...
        if ($novaMeta > 0) {
            ...
            if ($stmtCheck->rowCount() > 0) {
                // Atualiza meta se já existir registro
...
// Mensagem de exemplo (pode personalizar)
...
<body>
  ...
  <!-- Botões Administrativos (apenas para Superadmin) -->
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <p>
          ...
          <strong><?= $totalPontos ?></strong> / <?= $META_PONTOS ?>
        </p>
        <div class="progress">
          <!-- Barra interna -->
          <div 
            ...
            aria-valuemax="100"
          ></div>
          <!-- Icone/Imagem do Caju se mexendo conforme a barra -->
          <img 
            src="../assets/img/caju.png" 
            alt="Caju" 
            class="caju-run"
    ...
    <!-- Cartão Tabela de Pontuação das Peças -->
    <div class="card">
      <div class="card-header">
    ...
    <!-- Cartão Formulário para Adicionar Uso de Peça -->
    <div class="card">
      <div class="card-header">
