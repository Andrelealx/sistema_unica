...
// ---------------------
// 1) PROCESSAMENTO DAS AÇÕES (create, delete, update) - Igual ao seu código
// ---------------------
$action = $_POST['action'] ?? '';
...
// DELETE
    ...
    // Impede a exclusão do Super Admin (ID = 2)
    if ($user_id == 2) {
...
// ---------------------
// 2) SELECIONAR TODOS OS USUÁRIOS PARA EXIBIÇÃO
// ---------------------
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <!-- Botão Editar (abre o Modal específico do usuário) -->
              <button 
                type="button" 
                class="btn btn-warning btn-sm" 
                data-toggle="modal" 
                data-target="#editModal<?php echo $usuario['id']; ?>"
              >
          ...
          <!-- ========== MODAL DE EDIÇÃO PARA ESTE USUÁRIO ========== -->
          <div 
            class="modal fade" 
            id="editModal<?php echo $usuario['id']; ?>" 
            tabindex="-1" 
            role="dialog" 
            aria-labelledby="editModalLabel<?php echo $usuario['id']; ?>" 
            aria-hidden="true"
          >
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h5 class="modal-title" id="editModalLabel<?php echo $usuario['id']; ?>">
                    Editar Usuário (ID: <?php echo $usuario['id']; ?>)
                  </h5>
                ...
                <!-- Rodapé do Modal (botão de fechar, opcional) -->
